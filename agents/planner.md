...
- Write only under `openspec/changes/<name>/` (or `docs/changes/` in simple mode). No source edits.
...
<loop>
1. Read `proposal.md`, the related `openspec/specs/**`, the project CLAUDE.md/AGENTS.md, and
